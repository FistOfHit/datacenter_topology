...
import pandas as pd
from topology_generator.port_mapper import create_port_mapping, save_to_csv, save_to_excel
...
def test_save_to_csv():
    ...
    df = pd.DataFrame([
        {"source": "server1", "source_port": 0, "target": "leaf1", "target_port": 0, "bandwidth_gb": 10}
    ])
